...
var _pitches = __webpack_require__(3);

var Tone = __webpack_require__(2);
  ...
  for (var c = 0; c < 16; c++) {
    ...
    var _loop = function _loop(r) {
      ...
      classes.forEach(function (className) {
        return space.classList.add(className);
      });
...
var toggleNote = function toggleNote(e) {
  ...
  if (space.classList.contains('unselected')) {
    ...
    var idx = seqMap[col].indexOf(window.mode[space.pitch]);
