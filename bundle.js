...
module.exports = displayInstructions;
...
var furtherInstructions = function (instructionFrame) {
  return function (e) {
    e.stopPropagation();
...
var closeInstructions = function (instructionFrame) {
  return function (e) {
    e.stopPropagation();
...
module.exports = createLoopBar;

/***/ }),

/***/ "./javascript/play_functions.js":
/*!**************************************!*\
  !*** ./javascript/play_functions.js ***!
  \**************************************/
...
var transport = (__webpack_require__(/*! ./sequence */ "./javascript/sequence.js").transport);
...
var Tone = __webpack_require__(/*! tone */ "./node_modules/tone/build/Tone.js");

var merge = _interopRequire(__webpack_require__(/*! lodash/merge */ "./node_modules/lodash/merge.js"));

var _constants = __webpack_require__(/*! ./constants */ "./javascript/constants.js");

var defaultMap = _constants.defaultMap;
var pitches = _constants.pitches;
var intervals = _constants.intervals;
...
var sequenceMap = merge({}, defaultMap);
var eventIds = {};
...
exports.playPitch = playPitch;
var scheduleVisuals = function () {
  scheduleLoop();
  scheduleHighlights();
};

exports.scheduleVisuals = scheduleVisuals;
var scheduleLoop = function () {
  var loopBar = $w(".loop-bar");
  Tone.Transport.scheduleRepeat(function (time) {
    var startLeft = parseFloat(loopBar.css("left"));
    var newLeft = startLeft + 0.25;
...
var updateSequenceMap = function (space) {
  var col = space.attr("col");
  var mode = $w("#mode").attr("class");
  var pitch = pitches[mode][space.attr("pitch")];
  space.hasClass("selected") ? sequenceMap[col][pitch] = true : delete sequenceMap[col][pitch];
};

exports.updateSequenceMap = updateSequenceMap;
var scheduleNotes = function (col) {
  if (eventIds[col]) {
...
var clearMap = function () {
  return sequenceMap = merge({}, defaultMap);
};
...
var updateSequenceModality = function (oldMode, newMode) {
  for (var col = 0; col < 16; col++) {
    var column = sequenceMap[col];
    var adjusted = false;
    for (var i = 0; i < 4; i++) {
      var pitch = intervals[oldMode][i];
      if (column[pitch]) {
        delete column[pitch];
...
exports.updateSequenceModality = updateSequenceModality;
...
var pitches = _constants.pitches;
var demoSpaces = _constants.demoSpaces;

var displayInstructions = _interopRequire(__webpack_require__(/*! ./instructions */ "./javascript/instructions.js"));

var _grid = __webpack_require__(/*! ./grid */ "./javascript/grid.js");

var createGrid = _grid.createGrid;
var resetGrid = _grid.resetGrid;

var createFooter = _interopRequire(__webpack_require__(/*! ./footer */ "./javascript/footer.js"));

var createLoopBar = _interopRequire(__webpack_require__(/*! ./loop_bar */ "./javascript/loop_bar.js"));

var _play_functions = __webpack_require__(/*! ./play_functions */ "./javascript/play_functions.js");

var togglePlay = _play_functions.togglePlay;
var play = _play_functions.play;
var pause = _play_functions.pause;

var _sequence = __webpack_require__(/*! ./sequence */ "./javascript/sequence.js");

var playPitch = _sequence.playPitch;
var scheduleVisuals = _sequence.scheduleVisuals;
var updateSequenceMap = _sequence.updateSequenceMap;
var scheduleNotes = _sequence.scheduleNotes;
var updateSequenceModality = _sequence.updateSequenceModality;
var clearSequence = _sequence.clearSequence;
...
var toggleSpace = function (space) {
...
var demo = function () {
  clear();
  demoSpaces().forEach(function (space, i) {
    setTimeout(function () {
...
var displayDemoText = function () {
  var message = $w("<h1>");
  message.addClass("demo-text");
  message.html("A tune just for you...");
  $w("#grid").append(message);
  var demoText = $w(".demo-text");
  setTimeout(function () {
    return demoText.html("Let's go!");
  }, 100 * 45);
  setTimeout(function () {
    return demoText.remove();
  }, 100 * 50);
};
})();
